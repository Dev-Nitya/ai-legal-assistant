...
class CostMonitoringMiddleware(BaseHTTPMiddleware):
    """
    The "Budget Security Guard" for your AI application.
    ...
    def __init__(self, app, enabled: bool = True):
        ...
        self.ai_endpoints = [
            ...
            "/api/enhanced-chat",       # Enhanced chat with legal research
    ...
    async def dispatch(self, request: Request, call_next):
        ...
        This runs for EVERY request to your API. It decides whether
    ...
    def _estimate_response_length(self, user_question: str, model: str) -> int:
        """
        ...
        # Step 2: How complex is the question?
    ...
    def _analyze_question_complexity(self, question: str, input_tokens: int) -> float:
        """
        Analyze how complex the question is to estimate response length.
        Simple heuristics:
        - Long questions usually need detailed answers
        - Questions with technical terms need more explanation
        - Questions asking for analysis need comprehensive responses
        - Simple questions get concise answers
        
        Args:
            user_question: The user's question
            input_tokens: Number of tokens in the question
        ...
        complexity_indicators = {
            ...
            # Legal complexity (legal AI needs thorough answers)
            'contract': 0.4,
            'legal': 0.3,
            'clause': 0.3,
            'agreement': 0.3,
        ...
        # Factor 3: Question structure analysis
        question_marks = question.count('?')
        if question_marks > 1:
            complexity_score += 0.2

        # Factor 4: Presence of quotes or citations
        if '"' in question or 'section' in question_lower or 'page' in question_lower:
            complexity_score += 0.3  # Document analysis needs detailed responses

        complexity_score = max(0.5, min(2.5, complexity_score))

        logger.debug(f"Question complexity score: {complexity_score}")
